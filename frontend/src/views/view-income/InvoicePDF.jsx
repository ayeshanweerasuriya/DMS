...
export function InvoicePDF({ record }) {
  ...
  const treatments = [
    { name: 'Comprehensive Dental Examination', amount: record.treatmentFee },
    { name: 'Prescription Medications', amount: record.medicationFee || 0 },
    { name: 'Surgical Procedure & Hospitalization', amount: record.hospitalFee },
  ];
    ...
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.header}>
          <View>
            <Text style={{ fontSize: 18, fontWeight: 'bold', color: '#2b6cb0', marginBottom: 4 }}>
              DentalEase Center
            </Text>
          ...
          <View style={styles.invoiceMeta}>
            <Text style={{ fontSize: 14, fontWeight: 'bold', marginBottom: 4 }}>INVOICE</Text>
  ...
  Rs. {subtotal ? subtotal.toLocaleString('en-US') : '0.00'}
          ...
          <View style={[styles.tableRow, { borderBottomWidth: 0 }]}>
            ...
            <Text style={styles.tableCellAmount}>
  Rs. {tax ? tax.toLocaleString('en-US', { maximumFractionDigits: 2 }) : '0.00'}
</Text>
          </View>
          <View style={[styles.tableRow, { borderBottomWidth: 0 }]}>
            <Text style={[styles.tableCell, { fontWeight: 'bold' }]}>Total Due:</Text>
            <Text style={[styles.tableCellAmount, { fontWeight: 'bold' }]}>
  Rs. {totalAmount ? totalAmount.toLocaleString('en-US', { maximumFractionDigits: 2 }) : '0.00'}
</Text>
          </View>
        </View>
        ...
        <View style={{ marginTop: 20, fontSize: 10 }}>
          <Text style={{ fontWeight: 'bold', marginBottom: 6 }}>PAYMENT INSTRUCTIONS:</Text>
        ...
        <View style={styles.footer}>
          ...
          <Text>Services subject to terms & conditions • All taxes included • E&OE</Text>
          <Text>For queries: accounts@dentalEase.lk • +94 77 9876 5432 (Accounts Dept.)</Text>
        </View>
      </Page>
    </Document>
  );
